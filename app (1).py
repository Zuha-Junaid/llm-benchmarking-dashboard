...
st.markdown('<p class="main-header">Rocket LLM Benchmarking Dashboard</p>', unsafe_allow_html=True)
...
# --- Pre-compute all values as plain variables (avoids quote issues) ---
